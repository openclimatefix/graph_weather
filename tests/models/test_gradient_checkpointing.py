...
class TestLayerLevelCheckpointing:
    """Test fine-grained layer-level checkpointing."""

    @pytest.mark.parametrize("use_checkpointing", [False, True])
    def test_encoder_checkpointing(self, use_checkpointing):
    ...
    @pytest.mark.parametrize("use_checkpointing", [False, True])
    def test_processor_checkpointing(self, use_checkpointing):
        ...
        with torch.no_grad():
            out = processor(
                x, edge_index, edge_attr, batch_size=batch_size, efficient_batching=True
            )
    ...
    @pytest.mark.parametrize("use_checkpointing", [False, True])
    def test_decoder_checkpointing(self, use_checkpointing):
...
class TestOutputEquivalence:
    """Test that checkpointing produces identical outputs to non-checkpointed versions."""

    def test_encoder_output_equivalence(self):
    ...
    def test_full_pipeline_output_equivalence(self):
...
class TestGraphCastModel:
    """Test the complete GraphCast model with hierarchical checkpointing."""

    def test_graphcast_no_checkpointing(self):
    ...
    def test_graphcast_full_checkpointing(self):
    ...
    def test_graphcast_balanced_checkpointing(self):
    ...
    def test_graphcast_processor_only_checkpointing(self):
    ...
    def test_graphcast_output_equivalence(self):
...
class TestBackwardCompatibility:
    """Test that checkpointing doesn't break existing functionality."""
    ...
    def test_efficient_batching_unaffected(self):
...
class TestGradientFlow:
    """Test that gradients flow correctly with checkpointing."""

    @pytest.mark.skipif(not torch.cuda.is_available(), reason="Requires CUDA")
    def test_backward_pass_with_checkpointing(self):
...
class TestPreserveRngState:
    """Test that preserve_rng_state=False is correctly used."""

    def test_checkpoint_uses_correct_flags(self):
