...
from .data_assimilation import DataAssimilationModel, ThreeDVarLoss, SimpleDataAssimilationModel
    ...
    def evaluate_model(self, test_loader, compute_metrics=True):
        ...
        if compute_metrics and all_true:
            ...
            results.update({
                ...
                'improvement_over_bg': (bg_rmse - analysis_rmse) / bg_rmse * 100 if bg_rmse > 0 else 0,
                'improvement_over_obs': (obs_rmse - analysis_rmse) / obs_rmse * 100 if obs_rmse > 0 else 0
            })
