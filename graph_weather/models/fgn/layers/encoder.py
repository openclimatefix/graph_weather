...
class Encoder(torch.nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            noise_vector (torch.Tensor): noise vector for conditioning.
        ...
        # Embedding
        grid_emb = self.grid_mlp(input_grid_nodes, noise_vector)
        mesh_emb = self.mesh_mlp(input_mesh_nodes, noise_vector)
        edges_emb = self.edges_mlp(input_edge_attr, noise_vector)
